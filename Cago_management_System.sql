--DSE23.2F COURSEWORK------------------------------------------------------------------------
drop database Cago_management_System ;
...
--displaying the cagoID,dock and harbour where cargo is placed using Harbour,Dock and Cago_Operation tables
...
--displaying the shipID and Ship_name from ship and ship_operetion table using sub query
select S.ShipID,S.Ship_Name
from Ship S
...
--To create virtual table to displaying the data of the employees in management department.
...
--To create virtual table to displaying the data of items.
